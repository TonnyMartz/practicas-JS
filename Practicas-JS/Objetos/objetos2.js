...
let myObject = {
     myFunction: fillArray = (nombreProp, valor) => {

        Object.defineProperty(myObject, nombreProp, { value: valor})
...
let propiedad = 'PropiedadNumero1'
fillArray(propiedad, 42)


console.log(myObject.PropiedadNumero1)